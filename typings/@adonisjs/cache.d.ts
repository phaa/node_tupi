import { Fold, Redis } from "@adonisjs";
...
declare namespace Cache {
    interface Repository {
         ...
         * @param keys
         */
        many(keys: string[]): Promise<object>;
    ...
    interface TagSet {
         ...
         * @return
         */
        new(store: any, names: string[]): TagSet;
    ...
    interface RedisStore {
         ...
         * @return
         */
        tags(names: string[] | string): RedisTaggedCache;
