...
declare namespace Http {
    ...
    interface Response extends Macroable, nodeRes {
        ...
        /**
          ...
          * @return
          */
        _writeResponse(method : string, content : any, args : any[]): void;
        ...
        /**
          ...
          * @return
          */
        _invoke(method : string, content : any, args : any[]): void;
    ...
    class Session {
         ...
         * @return
         */
        flashOnly(...fields : string[]): Session;
         ...
         * @return
         */
        flashExcept(...fields : string[]): Session;
...
declare namespace Auth {
    ...
    interface BaseTokenScheme extends BaseScheme {
         ...
         * @return
         */
        revokeTokens(tokens? : string[] | null, deleteInstead? : boolean): Promise<number>;
         ...
         * @return
         */
        revokeTokensForUser(user : any, tokens? : string[] | null, deleteInstead? : boolean): Promise<number>;
...
declare namespace View {
    ...
    interface Context {
         ...
         * @return
         */
        accessChild(hash : any[] | Object, childs : String[], i? : number): any;
...
interface DatabaseManager {
    ...
    /**
      ...
      * @return
      */
    close(names? : string | string[]): void;
}
...
declare namespace Database {
    ...
    interface ValueMap { [key: string]: Value | QueryInterface; }
    ...
    type As = (columnName: string) => QueryInterface;
    ...
    type JoinRaw = (tableName: string, binding?: Value) => QueryInterface;
    ...
    type WithSchema = (schema: string) => QueryInterface;

    type WithWrapped = (alias: string, callback: (queryBuilder: QueryInterface) => any) => QueryInterface;
    ...
    type WhereWrapped = (callback: QueryCallback) => QueryInterface;

    type WhereNull = (columnName: string) => QueryInterface;
    ...
    type WhereBetween = (columnName: string, range: [Value, Value]) => QueryInterface;
    ...
    type WhereIn = (columnName: string, values: Value[]) => QueryInterface;

    interface GroupBy extends RawQueryBuilder, ColumnNameQueryBuilder {
    }

    type OrderBy = (columnName: string, direction?: string) => QueryInterface;
    ...
    type HavingIn = (columnName: string, values: Value[]) => QueryInterface;
    ...
    interface RawQueryBuilder {
        (sql: string, ...bindings: Array<Value | QueryInterface>): QueryInterface;
        (sql: string, bindings: Array<Value | QueryInterface> | ValueMap): QueryInterface;
        (raw: Raw): QueryInterface;
    }
    ...
    interface RawBuilder {
        (value: Value): Raw;
        (sql: string, ...bindings: Array<Value | QueryInterface>): Raw;
        (sql: string, bindings: Array<Value | QueryInterface> | ValueMap): Raw;
    }
...
declare namespace Validator {
    ...
    interface Formatter {
         ...
         * @return {void}
         */
        addError(error: Object, field: String, validation: String, args?: any[]): void;
    ...
    type MessageHandler = (field: String, validation: String, args: any[]) => String;
    ...
    interface Formatters { Vanilla: Validator.Formatter; JsonApi: Validator.Formatter; }
    type ValidatorHandler = (data: Object, field: string, message: string, args: any[], get: (obj: Object, path: string) => any) => Promise<any>;
    ...
    type Sanitizor = <T>(value: string, args?: T[]) => string;
    type SanitizorRaw = {
        [key in
            'normalizeEmail' |
            'stripTags' |
    ...
    interface ValidationException extends GE.RuntimeException {
        validationFailed (messages: string[]): ValidationException;
    }
...
declare namespace Fold {
    ...
    interface Registrar {
        ...
        /**
          ...
          */
        _getProvidersInstance(arrayOfProviders : Object[]): Object[];
          ...
          * @param providers
          */
        _registerProviders(providers : Object[]): void;
        ...
        /**
          ...
          * @return
          */
        _bootProviders(providers : Object[]): Promise<Object>;
        ...
        /**
          ...
          * @return
          */
        providers(arrayOfProviders : Object[]): this;
    ...
    interface Resolver {
        /**
          ...
          * @param forDirectory
          */
        new (Ioc : Ioc, directories : string[], appNamespace : string, forDirectory? : string): Resolver;
...
declare namespace Lucid {
    ...
    interface VanillaSerializer {
        ...
        /**
          ...
          * @param isOne
          */
        new(rows: Object[], pages?: null, isOne?: false): VanillaSerializer;
    ...
    interface QueryBuilder extends Pick<Database.Builder, aggregates> {
        ...
        /**
          ...
          * @return
          */
        ignoreScopes(scopes? : string[]): QueryBuilder;
        ...
        /**
          ...
          * @return
          */
        setVisible(fields : string[]): QueryBuilder;
        ...
        /**
          ...
          * @return
          */
        setHidden(fields : string[]): QueryBuilder;
    }
    ...
    namespace Relations {
        ...
        interface BaseRelation extends QueryProxy {
            ...
            /**
              ...
              * @return
              */
            eagerLoadQuery(fn: <T>(query: Object, fk: string, values: T[]) => void): void;
            ...
            /**
              ...
              * @return
              */
            eagerLoad(rows : any[]): Promise<Object>;
        ...
        interface HasOne extends BaseRelation {
            /**
              ...
              * @return
              */
            mapValues(modelInstances : any[]): Object[];
        ...
        interface BelongsTo extends BaseRelation {
            ...
            /**
              ...
              * @return
              */
            mapValues(modelInstances : Object[]): Object[];
            ...
            /**
              ...
              * @return
              */
            group(relatedInstances : Object[]): Object;
        ...
        interface BelongsToMany extends BaseRelation {
            ...
            /**
              ...
              * @return
              */
            withPivot(fields : string | string[]): this;
            ...
            /**
              ...
              * @return
              */
            whereInPivot(key : string, ...args : any[]): this;
            ...
            /**
              ...
              * @return
              */
            orWherePivot(key : string, ...args : any[]): this;
            ...
            /**
              ...
              * @return
              */
            andWherePivot(key : string, ...args : any[]): this;
            ...
            /**
              ...
              * @return
              */
            wherePivot(key : string, ...args : any[]): this;
            ...
            /**
              ...
              * @return
              */
            attach(references : Number | String | String[], pivotCallback? : pivotCallback, trx? : Database.Transaction): Promise<Object>;
            ...
            /**
              ...
              * @return
              */
            detach(references : String[], trx : Database.Transaction): number;
            ...
            /**
              ...
              * @return
              */
            sync(references : Number|String|String[], pivotCallback? : pivotCallback, trx? : Database.Transaction): Promise<void>;
            ...
            /**
              ...
              * @return
              */
            saveMany(arrayOfRelatedInstances : Object[], pivotCallback? : pivotCallback): Promise<void>;
            ...
            /**
              ...
              * @return
              */
            createMany(rows : Object[], pivotCallback : pivotCallback): Promise<Object[]>;
        }
        ...
        interface HasMany extends BaseRelation {
            ...
            /**
              ...
              * @return
              */
            createMany(arrayOfPayload : Object[], trx? : Database.Transaction): Promise<boolean>;
            ...
            /**
              ...
              * @return
              */
            saveMany(arrayOfRelatedInstances : Object[], trx? : Database.Transaction): Promise<boolean>;
        }
        ...
        interface HasManyThrough extends BaseRelation {
            ...
            relatedQuery          : QueryProxy;
            _relatedFields        : string[];
            _throughFields        : string[];
            _fields               : string[];
            /**
              *
              * @param parentInstance
    ...
    interface Model extends BaseModel {
        ...
        /**
          ...
          * @static
          */
        addHook(forEvent: ModelEvent, handlers: ((params: any) => void) | String | any[]): this;
        ...
        /**
          ...
          */
        createMany(payloadArray : Object[], trx? : Database.Transaction): Promise<Model[]>;
...
interface DatabaseFactory {
    ...
    /**
      ...
      * @return
      */
    createMany(numberOfRows : number, data? : {}): Promise<Object[]>;
...
declare namespace Redis {
    ...
    interface Core {
        ...
        /**
          ...
          * @return
          */
        quit(...name : string[]): Promise<string>;
    }
...
interface Antl {
	 ...
	 * @return
	 */
	formatMessage(message : string, values : Object, formats? : Object | any[]): string;
